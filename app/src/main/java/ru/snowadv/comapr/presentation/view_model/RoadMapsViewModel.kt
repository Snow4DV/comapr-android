...
import ru.snowadv.comapr.presentation.screen.roadmap.RoadMapsScreenState
...
class RoadMapsViewModel @Inject constructor(
    ...
    private val _state: MutableState<RoadMapsScreenState> = mutableStateOf(RoadMapsScreenState())
